...
const WHATSAPP = 'https://wa.me/5562992565904?text=Ol%C3%A1%2C%20tenho%20uma%20d%C3%BAvida%20e%20gostaria%20de%20conversar%20com%20o%20escrit%C3%B3rio.';
...
export default function FAQ() {
  return (
    <section id="faq" className="py-16 md:py-20" style={{ background: '#f8fafc' }}>
