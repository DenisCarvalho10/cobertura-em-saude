...
const WHATSAPP = 'https://wa.me/5562992565904?text=Ol%C3%A1%2C%20gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20os%20direitos%20da%20pessoa%20com%20TEA%20diante%20de%20negativa%20de%20cobertura.';
...
export default function AutismSection() {
  return (
    <section id="autismo" className="py-16 md:py-20 relative overflow-hidden" style={{ background: '#f0f7fc' }}>
      {/* Decorative */}
